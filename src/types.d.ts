...
declare global {
  ...
  interface AICreateMonitor extends EventTarget {
    ondownloadprogress:
      | ((this: AICreateMonitor, ev: DownloadProgressEvent) => any)
      | null;
  ...
  interface AIAssistantFactory {
    create(
      options?:
        ...
        | AIAssistantCreateOptionsWithoutSystemPrompt
    ): Promise<AIAssistant>;
  ...
  interface AIAssistantCreateOptionsWithSystemPrompt
    extends AIAssistantCreateOptions {
    systemPrompt?: string;
    initialPrompts?: Array<AIAssistantAssistantPrompt | AIAssistantUserPrompt>;
  }

  interface AIAssistantCreateOptionsWithoutSystemPrompt
    extends AIAssistantCreateOptions {
    systemPrompt?: never;
    initialPrompts?:
      | [
